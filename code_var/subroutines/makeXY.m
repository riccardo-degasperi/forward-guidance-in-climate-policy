...
iFD_endo              = data.iFD_endo;
iFD_global            = data.iFD_global;
...
% If global endogenous are there, modify iFD accordingly
iFD = [iFD_endo; iFD_global];
...
data.Xex             = Xex;
data.Xcovid          = Xcovid;
data.iFD             = iFD;             %update index for RW prior
