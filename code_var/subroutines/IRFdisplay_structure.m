function [ ] = IRFdisplay_structure(IRFstruc,varlist,longnames,shockVar,legNames,style,plotCase,plotOpt,chartName)
% Plots IRFs
    ...
    for i = (t-1)*rows*cols+1:t*rows*cols
        ...
        for j = 1:numel(names)
            ...
            if strcmp(names{j},'baseline')
                ...
                plot(0:h-1,tmp(3,:),style{j},'LineWidth',2,'MarkerSize',3);
            end
