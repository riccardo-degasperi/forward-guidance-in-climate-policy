...
clearvars -except z UU proxies t TT enddate shocks sign
close all
...
dataOpt.uT              = enddate{t};           %upper date cutoff (either 'full' or a date in text format)
...
dataOpt.shockSign       = sign{z};              %either 'positive' or 'negative'
...
if t == 1
hp.covid                = 1;                    %pandemic priors (Cascaldi-Garcia, 2024)
else
hp.covid                = 0;
end
...
if t == 1
plotOpt.folder          = ['figures_3_C3_C4/',dataOpt.variv{:},'/',enddate{t},'_PP'];  %either a folder name or []
else
plotOpt.folder          = ['figures_3_C3_C4/',dataOpt.variv{:},'/',enddate{t}];  %either a folder name or []
end
