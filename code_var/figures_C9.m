...
dataOpt.shockVar        = {'EUA_fq','es600','CMslope_18m1m'}; %shock of interest (position in the impact matrix)
...
dataOpt.varendo         = {'HICP_EN','GHG_IP','HICP_ALL','IP','INT3M','UNEMP','STOXX50','ROILEU','EUA_fq','es600','CMslope_18m1m'};
...
plotOpt.folder          = ['figures_C9'];       %either a folder name or []
